...
const Detail = () => {
    ...
    return (
        <Container>
            <Background>
                {/* to use firebase db, change it to <img src={movie.backgroundImg}/> or setup local json file*/}
                <img src="https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/4F39B7E16726ECF419DD7C49E011DD95099AA20A962B0B10AA1881A70661CE45/scale?width=1440&aspectRatio=1.78&format=jpeg" />
            </Background>
            <ImageTitle>
                {/* to use firebase db, change it to <img src={movie.titleImg}/> or setup local json file*/}
            ...
            <SubTitle>
                {/* to use firebase db, use {movie.subTitle} or setup local json file*/}
                2018 • 7m • Family, Fantasy, Kids, Animation
            </SubTitle>
            <Description>
                {/* to use firebase db, use {movie.description} or setup local json file */}
